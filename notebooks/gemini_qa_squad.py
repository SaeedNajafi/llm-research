...
genai.configure(api_key="AIzaSyDwA_6xfyJiIwrzEDfsJf-mt_T4F2w3oys")
...
def main(argv: Any) -> None:
    ...
    generation_config = genai.types.GenerationConfig(
        candidate_count=1, stop_sequences=["</s>"], max_output_tokens=32, temperature=0.0
    )
            ...
            squad_results.append(
                {
                    ...
                    "question": question,
                    "answers": row["answers"],
                    "gemini-1.0-pro-latest_answer": "<API_failed>",
                    "id": row["id"],
                }
            )
